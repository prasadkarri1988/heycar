...
public class CarControllerTest {
	...
	public void testSearchWithNoParam() throws Exception {
		...
		mockMvc.perform(get("/search/v1")).andExpect(status().isOk()).andExpect(jsonPath("content.[0].make").value("make"))
	...
	public void testSearchByMake() throws Exception {
		mockMvc.perform(get("/search/v1?make=Vauxhall")).andExpect(status().isOk())
	...
	public void testSearchByModel() throws Exception {
		mockMvc.perform(get("/search/v1?model=Corsa")).andExpect(status().isOk())
				.andExpect(jsonPath("content.[0].make").value("Vauxhall"))
	...
	public void testSearchByYear() throws Exception {
		...
		mockMvc.perform(get("/search/v1?year=2014")).andExpect(status().isOk())
	...
	public void testSearchByColor() throws Exception {
		mockMvc.perform(get("/search/v1?color=white")).andExpect(status().isOk())
