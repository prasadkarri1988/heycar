...
import com.heycar.nextcar.specification.CarListingSpecification;
...
public class CarSearchServiceImpl implements CarSearchService {
         ...
         */
        @Transactional
        public Page<CarListing> searchCars(CarListingRequest carSearchRequest, int page, int pageSize) {
     ...
     * @return
     */
    private Map<String, Object> getSearchCriteriaInMap(CarListingRequest carSearchRequest) {
